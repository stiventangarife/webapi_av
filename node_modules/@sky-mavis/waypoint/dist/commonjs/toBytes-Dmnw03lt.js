...
class SliceOffsetOutOfBoundsError extends base.BaseError {
  constructor({
    offset,
    position,
    size
...
class InvalidBytesLengthError extends base.BaseError {
  constructor({
    size,
    targetSize,
    type
...
function assertSize(hexOrBytes, {
  ...
  if (size.size(hexOrBytes) > size$1) throw new SizeOverflowError({
    givenSize: size.size(hexOrBytes),
    maxSize: size$1
  });
}
/**
...
function toBytes(value, opts = {}) {
  ...
  if (size.isHex(value)) return hexToBytes(value, opts);
