    ...
    case WaypointErrorMap.WALLET_NO_ADDRESS_ERR.code:
      {
        ...
        return new rpc.UnauthorizedProviderError(err);
      }
    ...
    case WaypointErrorMap.WALLET_CANT_SIMULATE.code:
      {
        ...
        return new rpc.TransactionRejectedRpcError(err);
      }
    default:
      {
        const err = new Error("unknown Ronin Waypoint error");
        return new rpc.InternalRpcError(err);
      }
  }
};

exports.WaypointErrorMap = WaypointErrorMap;
exports.normalizeWaypointError = normalizeWaypointError;
