...
const wasmBrowserInstantiate = async (wasmModuleUrl, importObject) => {
  if (!WebAssembly) {
    throw new headless_error_client.HeadlessClientError({
      code: headless_error_client.HeadlessClientErrorCode.WebAssemblyNotSupportedError,
  ...
  try {
    ...
    throw new headless_error_client.HeadlessClientError({
      code: headless_error_client.HeadlessClientErrorCode.InstantiateError,
      message: `Unable to instantiate WASM module with url="${wasmModuleUrl}".`,
      cause: error
    });
  }
};
const injectSkymavisMpc = async wasmModuleUrl => {
  if (!globalThis.Go) {
    try {
      setupGoWasmEnv();
    } catch (error) {
      throw new headless_error_client.HeadlessClientError({
        code: headless_error_client.HeadlessClientErrorCode.SetupGoWasmEnvError,
...
exports.injectSkymavisMpc = injectSkymavisMpc;
