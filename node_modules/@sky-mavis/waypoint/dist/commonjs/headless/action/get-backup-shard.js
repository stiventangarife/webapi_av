...
const getBackupClientShard = async params => {
  ...
  const {
    data,
    error
  } = await headless_action_helpers_request_request.request(`get ${httpUrl}/v1/public/backup/keys`, {
    headers: {
      authorization: waypointToken
    },
    key: headless_action_helpers_request_abortKey.AbortKey.getBackupClientShard
  });
  if (data) {
    return data.data;
  }
...
exports.getBackupClientShard = getBackupClientShard;
